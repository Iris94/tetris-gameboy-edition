import { activeTetrominos, copiedActiveTetromino, emptyBoardData, grid } from "../engine.js";
          ...
          for (let x = 0; x < Cols; x++) {
               ...
               if (originalActiveTetromino[grid[y][x] - 1]) {
                    promises.push(new Promise(resolve =>
                         dropAnimation(grid[y][x], duration, originalActiveTetromino, resolve)
                    ));
               }
          }
     }
